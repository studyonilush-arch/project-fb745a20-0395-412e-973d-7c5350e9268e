...
// עדויות אמיתיות בלבד. אין להוסיף כאן ציטוט ללא הסכמה מתועדת של הדובר.
// כל עוד המערך ריק, מקטע הסיפורים אינו מוצג באתר.
...
const Index = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const ok = await submitForm(form, "פנייה חדשה מעמוד הבית - אתר מל״ד");
    setSending(false);
    if (ok) {
